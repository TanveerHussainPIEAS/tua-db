...
(
	...
	[Deleted]				BIT				CONSTRAINT [DF_ProductType_IsDeleted] DEFAULT (0) NOT NULL,
	[CreatedDate]			DATETIMEOFFSET	CONSTRAINT [DF_ProductType_Created] DEFAULT (GETUTCDATE()) NOT NULL,	
	[ModifiedDate]			DATETIMEOFFSET 	CONSTRAINT [DF_ProductType_Modified] DEFAULT (GETUTCDATE()) NOT NULL,
