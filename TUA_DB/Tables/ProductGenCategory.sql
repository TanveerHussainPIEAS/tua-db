...
CREATE TABLE [dbo].[ProductGenCategory]
(
	[Id]					INT				IDENTITY(1,1) NOT NULL,	
	[Type]					NVARCHAR(300)	NOT NULL,
	[Deleted]				BIT				CONSTRAINT [DF_ProductGenCategory_IsDeleted] DEFAULT (0) NOT NULL,
	[CreatedDate]			DATETIMEOFFSET	CONSTRAINT [DF_ProductGenCategory_Created] DEFAULT (GETUTCDATE()) NOT NULL,	
	[ModifiedDate]			DATETIMEOFFSET 	CONSTRAINT [DF_ProductGenCategory_Modified] DEFAULT (GETUTCDATE()) NOT NULL,
	[DeletedDate]			DATETIMEOFFSET	NULL,
    [DeletedBy]				INT   NULL,
    [ModifiedBy]			INT   NULL,
	[CreatedBy]				INT   NULL,
	CONSTRAINT [PK_ProductGenCategory] PRIMARY KEY CLUSTERED ([ID] ASC),
