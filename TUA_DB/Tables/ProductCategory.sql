...
(
	...
	[Deleted]				BIT				CONSTRAINT [DF_ProductCategory_IsDeleted] DEFAULT (0) NOT NULL,
	[CreatedDate]			DATETIMEOFFSET	CONSTRAINT [DF_ProductCategory_Created] DEFAULT (GETUTCDATE()) NOT NULL,	
	[ModifiedDate]			DATETIMEOFFSET 	CONSTRAINT [DF_ProductCategory_Modified] DEFAULT (GETUTCDATE()) NOT NULL,
